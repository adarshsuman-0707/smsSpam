...
tfidf = pickle.load(open('e:/SMS-Spam-Detection-main (1)/SMS-Spam-Detection-main/vectorizer.pkl', 'rb'))
model = pickle.load(open('e:/SMS-Spam-Detection-main (1)/SMS-Spam-Detection-main/model.pkl', 'rb'))
